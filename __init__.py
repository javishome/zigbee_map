...
async def async_setup(hass, config):
    ...
    # mqtt.async_subscribe(hass, topic+'/bridge/networkmap/graphviz', message_received)
    # hass.async_create_task(mqtt.async_subscribe(hass, topic+'/bridge/networkmap/graphviz', message_received))
    ...
    async def update_service(call):
        ...
        tmpVar.update_data = None
        tmpVar.last_update = None
        hass.async_create_task(mqtt.async_publish(hass, topic+'/bridge/request/networkmap', 'graphviz'))
